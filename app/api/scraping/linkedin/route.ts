...
export async function POST(request: Request) {
  ...
  // Determine actor ID based on job type
  const actorId = job_type === 'linkedin_profile' 
    ? ACTOR_IDS.LINKEDIN_PROFILE 
    : ACTOR_IDS.LINKEDIN_SEARCH;

  const jobType = job_type === 'linkedin_profile' ? 'linkedin_profile' : 'linkedin_search';
